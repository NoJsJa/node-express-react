...
const { ReadDirsString } = require(path.resolve(process.cwd(), 'website/utils/Utils.js'));
...
const _pathLocator = function () {
  ...
  _path.public = path.resolve(_path.root, 'public/public');
  _path = Object.assign(_path, ReadDirsString(path.resolve(_path.root, 'website/app')));
};
